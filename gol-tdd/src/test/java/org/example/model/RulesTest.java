...
class RulesTest {
    ...
    void checkIfCellIsAliveAbove() {
        ...
        board.setCellState(5, 5, State.ALIVE);
        board.setCellState(5, 6, State.ALIVE);
    ...
    void checkIfCellIsAliveBelow() {
        ...
        board.setCellState(5, 5, State.ALIVE);
        board.setCellState(5, 4, State.ALIVE);
    ...
    void checkIfCellIsAliveRight() {
        ...
        board.setCellState(5, 5, State.ALIVE);
        board.setCellState(6, 5, State.ALIVE);
    ...
    void checkIfCellIsAliveLeft() {
        ...
        board.setCellState(5, 5, State.ALIVE);
        board.setCellState(4, 5, State.ALIVE);
    ...
    void checkIfCellIsAliveUpRight() {
        ...
        board.setCellState(5, 5, State.ALIVE);
        board.setCellState(6, 6, State.ALIVE);
    ...
    void checkIfCellIsAliveDownRight() {
        ...
        board.setCellState(5, 5, State.ALIVE);
        board.setCellState(6, 4, State.ALIVE);
    ...
    void checkIfCellIsAliveUpLeft() {
        ...
        board.setCellState(5, 5, State.ALIVE);
        board.setCellState(4, 6, State.ALIVE);
    ...
    void checkIfCellIsAliveDownLeft() {
        ...
        board.setCellState(5, 5, State.ALIVE);
        board.setCellState(4, 4, State.ALIVE);
    ...
    void checkIfCellIsAliveAroundUpLeftCornerOfBoard() {
        ...
        board.setCellState(-1, 0, State.ALIVE);
        board.setCellState(0, -1, State.ALIVE);
    ...
    void checkIfCellIsAliveAroundUpRightCornerOfBoard() {
        ...
        board.setCellState(21, 0, State.ALIVE);
        board.setCellState(21, -1, State.ALIVE);
        board.setCellState(21, 1, State.ALIVE);
    ...
    void checkIfCellIsAliveAroundDownLeftCornerOfBoard() {
        ...
        board.setCellState(0, 31, State.ALIVE);
        board.setCellState(-1, 31, State.ALIVE);
        board.setCellState(-1, 31, State.ALIVE);
    ...
    void checkIfCellIsAliveAroundDownRightCornerOfBoard() {
        ...
        board.setCellState(20, 30, State.ALIVE);
        board.setCellState(20, 31, State.ALIVE);
        board.setCellState(21, 30, State.ALIVE);
        board.setCellState(21, 31, State.ALIVE);
